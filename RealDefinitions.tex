...
\begin{enumerate}[leftmargin=*]
  ...
  \item $\mathbb{R}_\mathrm{FC}$ / $\mathbb{R}_\mathrm{I}$: fast Cauchy reals / interval reals (Cauchy sequences with explicit moduli or nested rational intervals) \cite{Chernov2021,AbrialCansell2021,ResearchGateCoinduction,Weihrauch2000,WikiNestedIntervals}.
  ...
  \item $\mathbb{R}_{b}$: coinductive base-$b$ reals (digit streams, e.g., binary/decimal) \cite{ResearchGateCoinduction,MathStackConstructiveReals,WiesnetKopp2021}.
  \item $\mathbb{R}_\mathrm{SD}$: signed-digit reals (streams over $\{-1,0,1\}$) \cite{WiesnetKopp2022,BauerKavkler2009,Escardo1996,Avizienis1961}.
  \item $\mathbb{R}_\mathrm{ID}$: interval domain reals (maximal elements of the interval domain) \cite{vanDerWeideFrumin2024,PattinsonMohammadian2021,deJong2023,BauerIntervalDomain,BauerTaylor2009,EdalatHeckmann1998,EdalatRealComputability,DiGianantonioReals,TaylorASDReals}.
