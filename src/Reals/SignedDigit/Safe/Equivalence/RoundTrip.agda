...
module Reals.SignedDigit.Safe.Equivalence.RoundTrip where
...
open import Reals.SignedDigit.Safe.Bounded using (stream→ℝ; rational→stream; clampℚ; -1ℚ; +1ℚ; rational→stream-clamp-eq; approxℚ₊; approxℚ₊-cauchy; approx-converges-ℚ₊)
