...
module Reals.SignedDigit.Safe.Equivalence.Coherence.RatRat where
...
open import Reals.SignedDigit.Safe.Bounded using (clampℚ; clamp-lip)
open import Reals.SignedDigit.Safe.Equivalence.RoundTrip using (round-trip-clamped)
